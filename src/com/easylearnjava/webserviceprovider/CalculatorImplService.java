 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://webserviceprovider.easylearnjava.com/", wsdlLocation = "http://localhost:8080/SOAP_Calculator_WebService_Provider/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://webserviceprovider.easylearnjava.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAP_Calculator_WebService_Provider/calc?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://webserviceprovider.easylearnjava.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webserviceprovider.easylearnjava.com/", "CalculatorImplPort"), Calculator.class, features);
    }
